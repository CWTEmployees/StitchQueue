<%@ Page Title="" Language="C#" MasterPageFile="~/StitchQueueMaster.Master" AutoEventWireup="true" CodeBehind="SlawarBottom.aspx.cs" Inherits="StitchQueue.slawar.SlawarBottom" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <link rel="stylesheet" href="./bottom/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="./bottom/style.css" type="text/css">
    <link rel="stylesheet" href="./bottom/responsive.css" type="text/css">
    <link rel="stylesheet" href="./bottom/animate.css" type="text/css">
    <link rel="stylesheet" href="./bottom/font-awesome.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link href="./bottom/jquery.filer-dragdropbox-theme.css" rel="stylesheet">
    <link href="./bottom/jquery.filer.css" rel="stylesheet">
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0">
    <link href="./bottom/css" rel="stylesheet">
    <link href="./bottom/css(1)" rel="stylesheet">
    <link href="./bottom/css(2)" rel="stylesheet">
    ...
    <script async="" src="./bottom/analytics.js.download"></script>
    <script src="./bottom/jquery.min.js.download" type="text/javascript"></script>
    <!-- nicescroll 
<script src="js/jquery.nicescroll.min.js" type="text/javascript"></script>
<script src="js/viewportchecker.js" type="text/javascript"></script>-->
    <!-- bootstrap script -->
    <script src="./bottom/bootstrap.min.js.download" type="text/javascript"></script>
    <script src="./bottom/jquery.filer.min.js.download" type="text/javascript"></script>
    ...
    <style>
        .residantal .active label, .pro-select .active label, .sortlist .active label, .borrowlist .active label, .currently-employed .active label, .property-cost .active label, .newdes-cost .active label, .newpos-cost .active label, .newcol-cost .active label, .newbck-cost .active label {
            background-image: url('bottom/Capture.png');
            cursor: pointer;
 ...
 We stitch your dress as per your best design so please design yourself to have the design.
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-3 cak">
                                    <div class="pro-box" onclick="storesleevevalue(1)">
                                        <label>
                                            <img src="./bottom/UTC226.png" class="image-responsive" alt="">
                                    ...
                                    <div class="pro-box" onclick="storesleevevalue(1)">
                                        <label>
                                            <a href="../index.html#contact">
                                                <img src="./bottom/UTC225.png" class="image-responsive" alt=""></a>
                                ...
                                <div class="col-lg-3 cak">
                                    <div class="pro-box" onclick="storesleevevalue(1)">
                                        <label>
                                            <img src="./bottom/Churidar1.png" class="image-responsive" alt="">
                                            <div class="view-back" style="text-align: center; font-family: Montserrat;">Churidar</div>
                                            <!--<div class="pro-box-buton" onclick="storesleevevalue(1)">Select</div>-->
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 cak">
                                    <div class="pro-box" onclick="storesleevevalue(2)">
                                        <label>
                                            <img src="./bottom/Salwar1.png" class="image-responsive" alt="">
                                            <div class="view-back" style="text-align: center; font-family: Montserrat;">Salwar</div>
                                ...
                                <div class="col-lg-3 cak">
                                    <div class="pro-box" onclick="storesleevevalue(3)">
                                        <label>
                                            <img src="./bottom/Patiala1.png" class="image-responsive" alt="">
                                            <div class="view-back" style="text-align: center; font-family: Montserrat;">Patiala</div>
                                ...
                                <div class="col-lg-3 cak">
                                    <div class="pro-box" onclick="storesleevevalue(4)">
                                        <label>
                                            <img src="./bottom/palazzo%20pants.png" class="image-responsive" alt="">
                                            <div class="view-back" style="text-align: center; font-family: Montserrat;">Palazzo</div>
                                ...
                                <div class="col-lg-3 cak">
                                    <div class="pro-box" onclick="storesleevevalue(5)">
                                        <label>
                                            <img src="./bottom/Straight-Pant.png" class="image-responsive" alt="">
                                            <div class="view-back" style="text-align: center; font-family: Montserrat;">Straight Pant</div>
                        ...
                        <div class="own-groups">
                            <a href="sleeve.html"><span class="btn btn-default btn-submit" onclick="goBack()"><i class="fa fa-angle-left" aria-hidden="true" style="font-size: 40px;"></i></span></a>
