<%@ Page Title="" Language="C#" MasterPageFile="~/StitchQueueMaster.Master" AutoEventWireup="true" CodeBehind="bottom.aspx.cs" Inherits="StitchQueue.DesignModel.bottom" %>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="step step-1" data-design="front">
                        <div class="row">
                            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 design-box" data-id="110">
                                <img src="bottom/pant/UTC225.png" class="img-responsive center center">
                                <p class="text-center">As per Your Material's Design</p>
                            </div>
                            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 design-box" data-id="111">
                                <img src="bottom/pant/UTC226.png" class="img-responsive center">
                                <p class="text-center">As per Mesurement Dress Design</p>
                            </div>
                            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 design-box" data-id="112">
                                <img src="bottom/pant/churidar1.png" class="img-responsive center">
                                <p class="text-center">churidar1</p>
                            </div>
                            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 design-box" data-id="113">
                                <img src="bottom/pant/palazzo pants.png" class="img-responsive center">
                                <p class="text-center">palazzo pants</p>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 design-box" data-id="114">
                                <img src="bottom/pant/Patiala1.png" class="img-responsive center">
                                <p class="text-center">Patiala1</p>
                            </div>
                            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 design-box" data-id="115">
                                <img src="bottom/Pant/Straight-Pant.png" class="img-responsive center">
                                <p class="text-center">Straight-Pant</p>
                            </div>
                            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 design-box" data-id="116">
                    ...
                    <div class="step step-2 hidden" data-design="back">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                    <img src="bottom/addon/Task-106-Add-Ons1.png" class="img-responsive">
                                    <P class="text-center">Task-106-Add-Ons1<br><br>
                                      Rs.0/-</P>
                                  </div>
