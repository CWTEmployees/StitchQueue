<%@ Page Title="" Language="C#" MasterPageFile="~/StitchQueueMaster.Master" AutoEventWireup="true" CodeBehind="BottomAddon.aspx.cs" Inherits="StitchQueue.bottom.BottomAddon" %>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 bol">
                                <div class="pro-box" onclick="toplining(2)">
                                    <label>
                                        ...
                                        <div class="view-back">American Crepe Lining</div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 bol">
                                <div class="pro-box" onclick="toplining(1)">
                                    <label>
                                        ...
                                        <div class="view-back">Premium Cotton Lining</div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 tab">
                                <div class="pro-box" onclick="closing(4)">
                                    <label>
                                        ...
                                        <div class="view-back">Back with Zip</div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    ...
                                    <div class="view-back">Dupatta Pico</div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    ...
                                    <div class="view-back">Piping</div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    ...
                                    <div class="view-back">Tassels with Neck Ties</div>
                                    <div class="view-back">Rs. 50/-</div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    ...
                                    <div class="view-back">Delivery in 5 days</div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 style">
                            <div class="pro-box" onclick="bstyle(2)">
                                <label>
                                    ...
                                    <div class="view-back">Waist with Strings</div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 style">
                            <div class="pro-box" onclick="bstyle(1)">
                                <label>
                                    ...
                                    <div class="view-back">Waist with Elastic</div>
                                    <div class="view-back">Rs. 50/-</div>
                                </label>
                            </div>
                        </div>
