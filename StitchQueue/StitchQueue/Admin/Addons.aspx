            ...
            <div class="container" style="margin: 0 auto;">
                ...
                <!--   <div class="form-inline">
                  ...
                  <div class="form-inline">
                    ...
                    <div class="col-md-4">
                        <input class="form-control" id="filebutton" name="filebutton" class="input-file" type="file" accept="image/gif, image/jpeg, image/png" onchange="readURL(this);" required="true">
