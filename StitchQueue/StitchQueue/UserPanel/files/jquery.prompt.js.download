...
;(function($){
	...
	$.fn.popup = function(message, callback, bugme ){
		...
		// build popup
		var $popup = $('<iframe class="jquery_prompt" allowtransparency=true frameborder="0" scrolling="auto" marginheight="0" marginwidth="0">\n\
    </iframe>\n\
<div class="jquery_prompt plugin">\n\
<form>'
						+'<div class="footer" id="jquery-prompt-box">'
                                        
						+'<input type="text" name="text" required="required" value="" style="display:none;"/>'
                                        
                                                +'<button class="prompt-ok-button" style="margin-left:0px;" type="submit" name="submit" value="1">Yes</button>'
                    
                                                +'<button class="prompt-cancel-button" type="reset" style="display:none;">No</button>'						
