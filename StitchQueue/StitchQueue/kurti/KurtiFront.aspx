<%@ Page Title="" Language="C#" MasterPageFile="~/StitchQueueMaster.Master" AutoEventWireup="true" CodeBehind="KurtiFront.aspx.cs" Inherits="StitchQueue.kurti.KurtiFront" %>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-3 bsf">
                                    <div class="pro-box" onclick="storefrontvalue(6)">
                                        <label>
                                            <img src="./front/18.png" class="image-responsive" alt="">
                                ...
                                <div class="col-lg-3 bsf">
                                    <div class="pro-box" onclick="storefrontvalue(18)">
                                        <label>
                                            <img src="./front/Peter-Pan-Collar.png" class="image-responsive" alt="">
                                            <div class="text-box" style="text-align: center; font-family: Montserrat;">Peter Pan Collar</div>
                                            <!--<div class="pro-box-buton" onclick="storefrontvalue(18)">Select</div>-->
                                        </label>
                                    </div>
                                </div>
