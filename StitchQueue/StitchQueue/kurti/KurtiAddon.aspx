<%@ Page Title="" Language="C#" MasterPageFile="~/StitchQueueMaster.Master" AutoEventWireup="true" CodeBehind="KurtiAddon.aspx.cs" Inherits="StitchQueue.kurti.KurtiAddon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="inner-banner">
        <img class="slider-image-responsive" src="./addon/product.jpg" width="100%" height="auto" alt="">
 ...
 We sew your dress as per your first-class layout so please design your self to have the layout.
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 tab">
                                <div class="pro-box" onclick="closing(4)">
                                    <label>
                                        <img src="./addon/Back-with-Zip1.png" class="image-responsive" alt="">
                    ...
                    <div class="property-cost-new">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    <img src="./addon/Tassels%20with%20Neck%20Ties1.png" class="image-responsive" alt="">
