<%@ Page Title="" Language="C#" MasterPageFile="~/StitchQueueMaster.Master" AutoEventWireup="true" CodeBehind="KurtiSleeve.aspx.cs" Inherits="StitchQueue.kurti.KurtiSleeve" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script async="" src="./sleeve/analytics.js.download"></script>
    <script src="./sleeve/jquery.min.js.download" type="text/javascript"></script>
    <!-- nicescroll    
