<%@ Page Title="" Language="C#" MasterPageFile="~/StitchQueueMaster.Master" AutoEventWireup="true" CodeBehind="BlouseBack.aspx.cs" Inherits="StitchQueue.blouse.BlouseBack" %>
...
<script src="js/viewportchecker.js" type="text/javascript"></script>-->
 ...
 We stitch your dress as per your best design so please design yourself to have the design.
                                    ...
                                    <div class="pro-box" onclick="storefrontvalue(1)">
                                        <label>
                                            <a href="../index.html#contact">
                                                <img src="./back/UTC225.png" class="image-responsive" alt=""></a>
                        ...
                        <div class="own-groups">
                            <a href="front.html"><span class="btn btn-default btn-submit"><i class="fa fa-angle-left" aria-hidden="true" style="font-size: 40px;"></i></span></a>
