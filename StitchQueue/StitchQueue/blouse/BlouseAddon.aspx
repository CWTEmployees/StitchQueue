<%@ Page Title="" Language="C#" MasterPageFile="~/StitchQueueMaster.Master" AutoEventWireup="true" CodeBehind="BlouseAddon.aspx.cs" Inherits="StitchQueue.blouse.BlouseAddon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="./addons/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="./addons/style.css" type="text/css">
    <link rel="stylesheet" href="./addons/responsive.css" type="text/css">
    <link rel="stylesheet" href="./addons/animate.css" type="text/css">
    <link rel="stylesheet" href="./addons/font-awesome.min.css">
    <link href="./addons/jquery.filer-dragdropbox-theme.css" rel="stylesheet">
    <link href="./addons/jquery.filer.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0">
    <link href="./addons/css" rel="stylesheet">
    <link href="./addons/css(1)" rel="stylesheet">
    <link href="./addons/css(2)" rel="stylesheet">
    ...
    <script async="" src="./addons/analytics.js.download"></script>
    <script src="./addons/jquery.min.js.download" type="text/javascript"></script>
    <!-- bootstrap script -->
    <script src="./addons_files/bootstrap.min.js.download" type="text/javascript"></script>
    ...
    <style>
        .residantal .active label, .pro-select .active label, .sortlist .active label, .borrowlist .active label, .currently-employed .active label, .property-cost .active label, .newdes-cost .active label, .newpos-cost .active label, .newcol-cost .active label, .newbck-cost .active label, .newgol-cost .active label, .newlab-cost .active label, .newlab-pre .active label, .newbot-pre .active label, .newbotom-pre .active label, .property-cost-new .active label {
            background-image: url('addons/Capture.png');
            cursor: pointer;
        }
    ...
    <div class="inner-banner">
        <img class="slider-image-responsive" src="./addons_files/product.jpg" width="100%" height="auto" alt="">
 ...
 We stitch your dress as per your best design so please design yourself to have the design.
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 bol">
                                <div class="pro-box" onclick="toplining(2)">
                                    <label>
                                        <img src="./addons/American-Crepe.png" class="image-responsive" alt="">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 bol">
                                <div class="pro-box" onclick="toplining(1)">
                                    <label>
                                        <img src="./addons/Task-106-Add-Ons1.png" class="image-responsive" alt="">
                    ...
                    <div class="newlab-cost">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 tab">
                                <div class="pro-box" onclick="closing(1)">
                                    <label>
                                        <img src="./addons/Front-with-Hooks1.png" class="image-responsive" alt="">
                                        <div class="view-back" style="text-align: center; font-family: Montserrat;">Front with Hooks</div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 tab">
                                <div class="pro-box" onclick="closing(2)">
                                    <label>
                                        <img src="./addons/Back-with-Hooks1.png" class="image-responsive" alt="">
                                        <div class="view-back" style="text-align: center; font-family: Montserrat;">Back with Hooks</div>
                                        <div class="view-back">Rs.0/-</div>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 tab">
                                <div class="pro-box" onclick="closing(3)">
                                    <label>
                                        <img src="./addons/Side-with-Zip1.png" class="image-responsive" alt="">
                                        <div class="view-back" style="text-align: center; font-family: Montserrat;">Side with Zip</div>
                    ...
                    <div class="property-cost-new">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    <img src="./addons/bls-3.png" class="image-responsive" alt="">
                                    <input type="checkbox" value="12" name="other" class="other">
                                    <div class="view-back" style="text-align: center; font-family: Montserrat;">Padded Blouse</div>
                                    <div class="view-back">Rs. 250/-</div>
                                </div>
                                <!--<div class="pro-box-buton" onclick="storeaddonvalue(12)">Select</div>-->
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    <img src="./addons/bls-2.png" class="image-responsive" alt="">
                                    <input type="checkbox" value="10" name="other" class="other">
                                    <div class="view-back" style="text-align: center; font-family: Montserrat;">Dart/Regular Blouse</div>
                                    <div class="view-back">Rs. 0/-</div>
                                </div>
                                <!--<div class="pro-box-buton" onclick="storeaddonvalue(10)">Select</div>-->
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    <img src="./addons/Binding-on-Neckline-and-Sle.png" class="image-responsive" alt="">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    <img src="./addons/bls-1.png" class="image-responsive" alt="">
                                    <input type="checkbox" value="11" name="other" class="other">
                                    <div class="view-back" style="text-align: center; font-family: Montserrat;">Princess cut Blouse</div>
                                    <div class="view-back">Rs. 50/-</div>
                                </div>
                                <!--<div class="pro-box-buton" onclick="storeaddonvalue(11)">Select</div>-->
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    <img src="./addons/Tassels-with-Neck-Ties1.png" class="image-responsive" alt="">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    <img src="./addons/Hemming-for-Dupatta1.png" class="image-responsive" alt="">
                                    <input type="checkbox" value="7" name="other" class="other">
                                    <div class="view-back" style="text-align: center; font-family: Montserrat;">Hemming for Saree</div>
                                    <div class="view-back">Rs. 50/-</div>
                                </div>
                                <!--<div class="pro-box-buton" onclick="storeaddonvalue(7)">Select</div>-->
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    <img src="./addons/Task-106-Add-Ons2.png" class="image-responsive" alt="">
                                    <input type="checkbox" value="1" name="other" class="other">
                                    <div class="view-back" style="text-align: center; font-family: Montserrat;">Saree Falls &amp; Pico</div>
                                    <div class="view-back">Rs. 125/-</div>
                                </div>
                                <!--<div class="pro-box-buton" onclick="storeaddonvalue(1)">Select</div>-->
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 other-item">
                            <div class="pro-box">
                                <div class="check-box">
                                    <img src="./addons/deli.png" class="image-responsive" alt="">
                    ...
                    <div class="own-groups">
                        <a href="sleeve.html"><span class="btn btn-default btn-submit"><i class="fa fa-angle-left" aria-hidden="true" style="font-size: 40px;"></i></span></a>
...
<div class="pro-box-buton">Select</div>
    ...
    <script src="./addons_files/wow.min.js.download" type="text/javascript"></script>
    <script>
        new WOW().init();
     </script>
