<%@ Page Title="" Language="C#" MasterPageFile="~/StitchQueueMaster.Master" AutoEventWireup="true" CodeBehind="BlouseFront.aspx.cs" Inherits="StitchQueue.blouse.BlouseFront" %>
...
<script src="js/viewportchecker.js" type="text/javascript"></script>-->
 ...
 We stitch your dress as per your best design so please design yourself to have the design.
                        ...
                        <div class="newpos-cost">
                            <div class="col-lg-12">
                                <asp:DataList ID="Product" runat="server" DataSourceID="SqlDataSource1">
                                    <ItemTemplate>
                                        <div class="col-lg-3 bsf">
                                            <div class="pro-box" onclick="storefrontvalue(1)">
                                                <label>
                                                    <img src="<%#Eval("Images") %>" class="image-responsive" alt="">
                                                    <div class="view-back" style="text-align: center; font-family: Montserrat;"><%#Eval("StyleName") %></div>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbconnection %>" SelectCommand="SELECT * FROM [Design] WHERE ([ProductId] = @ProductId) AND ([DesignName] = @DesignName) ">
                                    <SelectParameters>
                                        <asp:QueryStringParameter Name="ProductId" QueryStringField="cat" Type="Int32" />
                                        <asp:QueryStringParameter Name="DesignName" QueryStringField="design" Type="Int32" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
