<%@ Page Title="" Language="C#" MasterPageFile="~/StitchQueueMaster.Master" AutoEventWireup="true" CodeBehind="BlouseSleeve.aspx.cs" Inherits="StitchQueue.blouse.BlouseSleeve" %>
...
<script src="js/viewportchecker.js" type="text/javascript"></script>-->
    ...
    <div class="row">
        <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <form action="addons.html" method="post" onsubmit="return checkvalue();">
 ...
 We stitch your dress as per your best design so please design yourself to have the design.
                                    ...
                                    <div class="pro-box" onclick="storefrontvalue(1)">
                                        <label>
                                            <a href="../index.html#contact">
                                                <img src="./sleeve/UTC225.png" class="image-responsive" alt=""></a>
                        ...
                        <div class="own-groups">
                            <a href="back.html"><span class="btn btn-default btn-submit"><i class="fa fa-angle-left" aria-hidden="true" style="font-size: 40px;"></i></span></a>
